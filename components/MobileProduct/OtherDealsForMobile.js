...
const tripData = [
  {
    ...
    linkUrl: "/AndroidDeals/SamsungMobiles",
  },
  {
    id: 2,
    title: "Vivo Mobiles",
    ...
    imageUrl: Vivo,
    linkUrl: "/AndroidDeals/VivoMobiles",
  },
  {
    id: 3,
    title: "Oppo Mobiles",
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-2 text-white">
                ...
                <Link href={trip.linkUrl}>
                  <Button
                    radius="full"
                    className="bg-gradient-to-tr text-sm font-bold p-0 mt-1 from-pink-500 to-yellow-500 text-white shadow-lg"
                  >
                    View
                  </Button>
                </Link>
